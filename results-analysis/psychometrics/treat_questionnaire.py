...
def treat_nasa_tlx(df):
    ...
    df.to_csv('nasa_tlx/nasa_tlx_all.csv')
    ...
    new_df_zpdes.to_csv('nasa_tlx_zpdes_split.csv')
    new_df_baseline.to_csv('nasa_tlx_baseline_split.csv')
...
def treat_UES(df):
    ...
    save_boxplots(all_df[all_df['condition'] == "baseline"], conditions_to_keep, 'ues', additional_tag="baseline-all-")
    ...
    pre_post_df_baseline.to_csv('ues/ues_baseline_split.csv')
    pre_post_df_zpdes.to_csv('ues/ues_zpdes_split.csv')
...
def treat_SIMS(df):
    ...
    new_df_zpdes.to_csv('sims/sims_zpdes_split.csv')
    new_df_baseline.to_csv('sims/sims_baseline_split.csv')
    diff_df_baseline = new_df_baseline.groupby('id_participant')[conditions].diff().dropna()
    diff_df_zpdes = new_df_zpdes.groupby('id_participant')[conditions].diff().dropna()
...
def treat_TENS(df):
    ...
    new_df_zpdes.to_csv('tens/tens_zpdes_split.csv')
    new_df_baseline.to_csv('tens/tens_baseline_split.csv')
    diff_df_baseline = new_df_baseline.groupby('id_participant')[conditions].diff().dropna()
    diff_df_zpdes = new_df_zpdes.groupby('id_participant')[conditions].diff().dropna()
